...
func InitOptionMap() {
	...
	common.OptionMap["SensitiveWordExemptUserIDs"] = setting.SensitiveWordExemptUserIDsToString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "SensitiveWordExemptUserIDs":
		setting.SensitiveWordExemptUserIDsFromString(value)
