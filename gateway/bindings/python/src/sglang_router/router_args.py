...
class RouterArgs:
    ...
    routing_map_file: Optional[str] = None  # 09-16: persist/restore manual policy routing table across restarts
    ...
    def add_cli_args(
        ...
        routing_group.add_argument(
            f"--{prefix}routing-map-file",
            type=str,
            default=RouterArgs.routing_map_file,
            help="09-16: path to persist/restore the manual policy routing table (session stickiness across gateway restarts); empty = disabled",
        )
        routing_group.add_argument(
