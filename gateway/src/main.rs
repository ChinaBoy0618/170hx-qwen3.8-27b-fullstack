...
struct CliArgs {
    ...
    /// 09-16: optional path to persist/restore the manual policy sticky
    /// session table (routing_map) across gateway restarts
    #[arg(long, help_heading = "Routing Policy")]
    routing_map_file: Option<String>,
    ...
    fn parse_policy(&self, policy_str: &str) -> PolicyConfig {
        match policy_str {
            ...
            "manual" => PolicyConfig::Manual {
                ...
                routing_map_file: self.routing_map_file.clone(),
            },
